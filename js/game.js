...
// Step 01 .. jtg .. Create game canvas and track mouse position
...
// Step 02 .. jtg .. Clear page canvas by covering it in black.
...
// Step 03 .. jtg .. Place a ball on the canvas
...
// Step 04 .. jtg .. Place a start button on canvas
...
// Step 07 .. jtg .. Detect when the user clicks on the screen
...
// Step 08 .. jtg .. Draw everything on canvas over and over again
...
function check4collision() {
    ...
    if (collides(ball, pTop)) {
        ...
        // Top or bottom of screen -- Game Over
        if (ball.y + ball.r > H) {
            // Game over
            gameOver();
        } else if (ball.y < 0) {
